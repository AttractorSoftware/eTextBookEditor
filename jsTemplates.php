...
<div class="template" name="moduleControlPanel">
    <control-panel class="module-panel">
        <item class="edit" title="Редактировать">
            <span class="glyphicon glyphicon-pencil"></span>
        </item>
        <item class="duplicate" title="Дублировать">
            <span class="glyphicon glyphicon-repeat"></span>
        </item>
        <item class="remove" title="Удалить">
...
<div class="template" name="testWidgetTask">
    <div class="task">
...
<div class="template" name="addChoice">
    <edit-element class="add-choice">
        <input placeholder="Вариант ответа" type="text">

        <div class="add glyphicon glyphicon-plus"></div>
    </edit-element>
</div>

<div class="template" name="addKyrgyzChars">
    <div class="kyrgyz-chars">
