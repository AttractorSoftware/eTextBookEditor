var eTextBookWidgetTest = eTextBookWidget.extend({
    ...
    addQuestionWithChoice: function (obj) {
        ...
        obj.find('.question').html(App.eTextBookTemplate.getTemplate('emptyQuestion'));
    ...
    parseQuestion: function (obj) {
        var value = obj.children('input').val();
        obj.html(App.eTextBookTemplate.getTemplate('editedQuestion'));
        obj.children('h5').html(value).show("normal");
    },
    ...
    binds: function () {
        ...
        $('.test-widget')
            .on('click', '.question .add', function () {
                $this.parseQuestion($(this).closest('.question'));
